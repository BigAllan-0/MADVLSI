...
.control
	...
	set wr_singlescale
	dc Vin 0 1.8 0.01
	wrdata ~/Documents/MADVLSI_MP1/CMOSinverter.txt v(Vout)
.endc"
...
C {madvlsi/vsource.sym} -200 -210 0 0 {name=Vin
value=1}
C {madvlsi/gnd.sym} -200 -180 0 0 {name=Vin2 lab=GND
value=1}
C {lab_pin.sym} -200 -240 1 0 {name=p3 sig_type=std_logic lab=Vin
}
